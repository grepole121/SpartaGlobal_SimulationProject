        ...
        b.setOnAction(e -> {
            try {
                if (dataAccessOptionsBox.getValue() != null && whatDataOptionsBox.getValue() != null) {
                    ...
                    if (whatDataOptionsBox.getValue() == "Final Month Only") {
                        outputSelection[0] = 2;
                    } else {
                        outputSelection[0] = 1;
                    }
                    if (dataAccessOptionsBox.getValue() == "Print to Screen") {
                        outputSelection[1] = 1;
                    }
                    if (dataAccessOptionsBox.getValue() == "Save To Text File") {
                        outputSelection[1] = 2;
                    } else {
                        outputSelection[1] = 3;
                    }
                } else {
                    v.generateView(primaryStage, FailedStartUpScene(primaryStage));
                }
